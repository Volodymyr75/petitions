...
> **Останнє оновлення:** 2025-12-26 13:03  
...
2. **Dashboard** (`Dashboard.jsx`)
   - KPI карточки (total, president, cabinet, top vote)
   - Trending секція з дельтами голосів
   - Pie chart (розподіл по платформах)
   - Bar chart (топ петиції)
   - Top-5 списки (president / cabinet)

3. **Дані оновлені** — `generated_at: 2025-12-13`

---

## 🚧 Що в процесі / Наступні кроки

### Запланована архітектура дашборду (4 блоки):

1. **Overview** — KPI + найстаріші петиції "На розгляді"
2. **Daily Dynamics** — тренди по дельтах, історичні графіки голосів
3. **Core Analysis** — розподіли статусів, текстові характеристики
4. **Technical Audit** — аналіз ID gaps, здоров'я пайплайну

### TODO:
- [ ] Створити таблицю `votes_history` для історичних снепшотів
- [ ] Реалізувати daily sync з ID-based оновленнями
- [ ] Додати блоки 3-4 в Dashboard
